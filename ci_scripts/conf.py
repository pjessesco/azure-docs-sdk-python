...
namespace_package_dict = {
  ...
  'azure_mgmt_batchai-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-batchai',
  'azure_mgmt_containerinstance-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-containerinstance',
  'azure_mgmt_containerservice-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-containerservice',
  'azure_mgmt_cosmosdb-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-cosmosdb',
  'azure_mgmt_datafactory-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-datafactory',
  'azure_mgmt_eventgrid-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-eventgrid',
  'azure_mgmt_machinelearningcompute-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-machinelearningcompute',
  'azure_mgmt_recoveryservices-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-recoveryservices',
  'azure_mgmt_relay-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-relay',
  'azure_mgmt_servicefabric-([A-Za-z0-9\-\.]*).egg': 'azure-mgmt-servicefabric',
}
